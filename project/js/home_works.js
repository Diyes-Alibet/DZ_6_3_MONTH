...
request.open('GET', '../js/persons.json');
...
request.onload = () =>{
    ...
    const nissan = new  XMLHttpRequest();
nissan.open('GET', 'any.json');
nissan.setRequestHeader('Content-type', 'application/json');
nissan.send()
nissan.onload = function () {
    const japan = JSON.parse(nissan.response);
    console.log(japan)
